...
<body>
	...
	<hr>
	<div class="container" style="text-align: center;">		<!-- 하나의 영역 생성 -->
		<div class="login_div" style="padding-top: 20px;">
			<form method="post" action="loginAction.jsp" style="display:inline-block;">
				<h3 style="font-size:50px;">로그인 화면</h3>
